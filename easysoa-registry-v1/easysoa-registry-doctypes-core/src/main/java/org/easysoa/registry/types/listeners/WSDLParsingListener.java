	...
	public void handleEvent(Event event) throws ClientException {
        ...
        if (InformationService.DOCTYPE.equals(sourceDocument.getType())) {
        	if (sourceDocument.getPropertyValue(InformationService.XPATH_WSDL_PORTTYPE_NAME) == null) {
        		InformationServiceSoaNodeId parsedSoaName = new InformationServiceSoaNodeId(
        	...
        	ServiceImplementationSoaNodeId parsedSoaName = new ServiceImplementationSoaNodeId(
					...
					if (wsdl != null) {
						...
						if (InformationService.DOCTYPE.equals(sourceDocument.getType())) {
							sourceDocument.setPropertyValue(InformationService.XPATH_SOANAME,
									new InformationServiceSoaNodeId(ServiceIdentifierType.WEB_SERVICE,
