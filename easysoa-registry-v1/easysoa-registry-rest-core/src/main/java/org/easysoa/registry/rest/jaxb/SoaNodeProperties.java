...
/**
 * This value impl replaces a Map by a List of SoaNodeProperty.
 * 
...
public class SoaNodeProperties extends SoaNodePropertyValue {

    /**
     * @XmlElementRef tells it to use the class name as XML tag and vice versa.
