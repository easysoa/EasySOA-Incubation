 ...
 * 2013-01-14T15:33:57.211+01:00
 * Generated source version: 2.7.0
 * 
 */
@WebServiceClient(name = "ContactSvc", 
                  wsdlLocation = "file:/home/mdutoo/dev/easysoa/workspace/EasySOA-Incubation/easysoa-samples/easysoa-samples-axxx/axxx-dps-apv/axxx-dps-apv-core/src/main/resources/axxx-dcv-pivotal/ContactSvc.asmx.wsdl",
...
public class ContactSvc extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/mdutoo/dev/easysoa/workspace/EasySOA-Incubation/easysoa-samples/easysoa-samples-axxx/axxx-dps-apv/axxx-dps-apv-core/src/main/resources/axxx-dcv-pivotal/ContactSvc.asmx.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ContactSvc.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/mdutoo/dev/easysoa/workspace/EasySOA-Incubation/easysoa-samples/easysoa-samples-axxx/axxx-dps-apv/axxx-dps-apv-core/src/main/resources/axxx-dcv-pivotal/ContactSvc.asmx.wsdl");
        }
        WSDL_LOCATION = url;
    }
