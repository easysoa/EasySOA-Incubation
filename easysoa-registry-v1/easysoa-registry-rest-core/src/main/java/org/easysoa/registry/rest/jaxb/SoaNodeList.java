...
/**
 * This value impl replaces a generic List or array by a List of SoaNodePropertyValue.
...
public class SoaNodeList extends SoaNodePropertyValue {
    ...
    public SoaNodeList(List<SoaNodePropertyValue> list) {
