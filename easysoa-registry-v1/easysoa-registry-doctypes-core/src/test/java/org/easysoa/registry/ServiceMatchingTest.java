...
public class ServiceMatchingTest extends AbstractRegistryTest {
    ...
    public void testDiscoveryAcrossVersionedSubproject() throws Exception {
        ...
        DocumentModel foundInfoServ = discoveryService.runDiscovery(documentManager, CSP_INFORMATIONSERVICE_ID, isProperties, null, ContextVisibility.DEEP.getValue());
        ...
        DocumentModel foundComponent = discoveryService.runDiscovery(documentManager, CSP_COMPONENT_ID, compProperties, null, ContextVisibility.DEEP.getValue());
        ...
        DocumentModel foundImpl = discoveryService.runDiscovery(documentManager, CSP_FIRST_SERVICEIMPL_ID, implProperties, null, ContextVisibility.DEEP.getValue());
    ...
    public void testSimpleDiscovery() throws Exception {
    	...
    	implProperties.put(ServiceImplementation.XPATH_TECHNOLOGY, Platform.SERVICE_LANGUAGE_JAXWS);
    	implProperties.put(ServiceImplementation.XPATH_WSDL_PORTTYPE_NAME, "{namespace}name");
        discoveryService.runDiscovery(documentManager, CSP_FIRST_SERVICEIMPL_ID, implProperties, null, ContextVisibility.DEEP.getValue());
        ...
        discoveryService.runDiscovery(documentManager, CSP_SECOND_SERVICEIMPL_ID, implProperties, null, ContextVisibility.DEEP.getValue());
        ...
        discoveryService.runDiscovery(documentManager, CSP_SECOND_SERVICEIMPL_SEPARATE_SUBPROJECT_ID, anotherImplProperties, null, ContextVisibility.DEEP.getValue());
        ...
        discoveryService.runDiscovery(documentManager, THIRD_SERVICEIMPL_ID, impl3Properties, null, ContextVisibility.DEEP.getValue());
        ...
        foundInfoServ  = discoveryService.runDiscovery(documentManager, CSP_INFORMATIONSERVICE_ID, isProperties, null, ContextVisibility.DEEP.getValue());
        foundImpl = discoveryService.runDiscovery(documentManager, CSP_SECOND_SERVICEIMPL_ID, implProperties, null, ContextVisibility.DEEP.getValue());
    ...
    public void testSimpleDiscoveryWithCriteria() throws Exception {
        ...
        discoveryService.runDiscovery(documentManager, new SoaNodeId(ServiceImplementation.DOCTYPE, "nsxxx:namexxx=servicenamexxx" + "N1KO"), implN1Properties, null, ContextVisibility.DEEP.getValue());
        ...
        discoveryService.runDiscovery(documentManager, FIRST_SERVICEIMPL_ID, implProperties, null, ContextVisibility.DEEP.getValue());
        ...
        discoveryService.runDiscovery(documentManager, new SoaNodeId(ServiceImplementation.DOCTYPE, "nsxxx:namexxx=servicenamexxx" + "N2KO"), implN2Properties, null, ContextVisibility.DEEP.getValue());
    	...
    	discoveryService.runDiscovery(documentManager, new SoaNodeId(InformationService.DOCTYPE, "nsxxx:namexxx" + "N1KO"), isN1Properties, null, ContextVisibility.DEEP.getValue());
    	...
    	DocumentModel foundInfoServ = discoveryService.runDiscovery(documentManager, INFORMATIONSERVICE_ID, isProperties, null, ContextVisibility.DEEP.getValue());
    	...
    	// Discover another impl
        discoveryService.runDiscovery(documentManager, SECOND_SERVICEIMPL_ID, implProperties, null, ContextVisibility.DEEP.getValue());
        ...
        foundInfoServ = discoveryService.runDiscovery(documentManager, new SoaNodeId(InformationService.DOCTYPE, "nsxxx:namexxx" + "P1KO"), isProperties, null, ContextVisibility.DEEP.getValue());
        foundImpl = discoveryService.runDiscovery(documentManager, new SoaNodeId(ServiceImplementation.DOCTYPE, "nsxxx:namexxx=servicenamexxx" + "P1KO"), implProperties, null, ContextVisibility.DEEP.getValue());
        ...
        DocumentModel foundEndpoint = discoveryService.runDiscovery(documentManager, new EndpointId("Production", "staging:http://localhost:8080/cxf/WS1"), epProperties, null, ContextVisibility.DEEP.getValue());
        ...
        foundEndpoint = discoveryService.runDiscovery(documentManager, new EndpointId("staging", "http://localhost:8080/cxf/name"), epProperties, null, ContextVisibility.DEEP.getValue());
        ...
        compProperties.put(Platform.XPATH_SERVICE_LANGUAGE, Platform.SERVICE_LANGUAGE_JAXWS);
        compProperties.put(Component.XPATH_COMP_LINKED_INFORMATION_SERVICE, foundInfoServ.getId());
        DocumentModel foundComponent = discoveryService.runDiscovery(documentManager, COMPONENT_ID, compProperties, null, ContextVisibility.DEEP.getValue());
        ...
        foundEndpoint = discoveryService.runDiscovery(documentManager,  new EndpointId("staging", "http://localhost:8080/cxf/WS2"), epProperties, null, ContextVisibility.DEEP.getValue());
        ...
        foundEndpoint = discoveryService.runDiscovery(documentManager,  new EndpointId("staging", "http://localhost:8080/cxf/WS3"), epProperties, null, ContextVisibility.DEEP.getValue());
        Assert.assertNotNull("Created endpoint must be linked to existing matching information service",
        		foundEndpoint.getPropertyValue(ServiceImplementation.XPATH_PROVIDED_INFORMATION_SERVICE));
    	...
    	foundImpl = discoveryService.runDiscovery(documentManager, new SoaNodeId(ServiceImplementation.DOCTYPE, "nszzz:namezzz=servicenamezzz" + "C1KO"), implProperties, null, ContextVisibility.DEEP.getValue());
    	...
    	foundImpl = discoveryService.runDiscovery(documentManager, new SoaNodeId(ServiceImplementation.DOCTYPE, "nszzz:namezzz=servicenamezzz" + "C1OK"), implProperties, null, ContextVisibility.DEEP.getValue());
    	...
    	foundInfoServ = discoveryService.runDiscovery(documentManager, new SoaNodeId(InformationService.DOCTYPE, "nswww:namewww"), isProperties, null, ContextVisibility.DEEP.getValue());
       
        epProperties.clear();
        epProperties.put(Endpoint.XPATH_TECHNOLOGY, Platform.SERVICE_LANGUAGE_JAXWS); // TODO better ?!?
        epProperties.put(Endpoint.XPATH_WSDL_PORTTYPE_NAME, "{www}www");
    	foundEndpoint = discoveryService.runDiscovery(documentManager, new EndpointId("Prod", "www.com"), epProperties, null, ContextVisibility.DEEP.getValue());
        ...
        */
        ...
        foundEndpoint = discoveryService.runDiscovery(documentManager, new EndpointId("Prod", "www.a.com/noISEndpoint"), epProperties, null, ContextVisibility.DEEP.getValue());

        implProperties.put(ServiceImplementation.XPATH_WSDL_PORTTYPE_NAME, "{www}noISEndpoint");
        foundImpl = discoveryService.runDiscovery(documentManager, new SoaNodeId(ServiceImplementation.DOCTYPE, "www:noISEndpoint=noISEndpointImplService" + "C1KO"), implProperties, null, ContextVisibility.DEEP.getValue());
        ...
        discoveryService.runDiscovery(documentManager, new EndpointId("staging", "http://localhost:8080/cxf"), epProperties, null, ContextVisibility.DEEP.getValue());
